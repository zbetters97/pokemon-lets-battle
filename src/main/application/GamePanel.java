...
public class GamePanel extends JPanel implements Runnable {
    ...
    public Map<Integer, Map<Pokedex, Integer>> wildEncounters_Surfing = new HashMap<>();
    public Map<Integer, Integer> wildLevels_Surfing = new HashMap<>();
    ...
    protected void setupGame() {
        ...
        if (!saveDir.exists()) {
            boolean saveCreated = saveDir.mkdir();
        }
    ...
    private void setupWildPokemon() {
        ...
        wildEncounters_Surfing.put(
                petalburg, Map.ofEntries(
                        Map.entry(Pokedex.MAGIKARP, 70),
                        Map.entry(Pokedex.HORSEA, 25),
                        Map.entry(Pokedex.SPHEAL, 5)
                )
        );
        wildLevels_Surfing.put(petalburg, 6);
    }
