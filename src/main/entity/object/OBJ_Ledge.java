...
public class OBJ_Ledge extends Entity {
    ...
    public OBJ_Ledge(GamePanel gp, int x, int y, String direction, int tiles) {
        ...
        switch (direction) {
            case "up":
                up1 = getImageHor(power, up1, up2, up3);
                break;
            case "down":
                down1 = getImageHor(power, down1, down2, down3);
                break;
            case "left":
                left1 = getImageVer(power, left1, left2, left3);
                break;
            case "right":
                right1 = getImageVer(power, right1, right2, right3);
                break;
        }
    }
